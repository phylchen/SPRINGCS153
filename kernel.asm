...
80102da7:	e8 04 29 00 00       	call   801056b0 <idtinit>
...
80102dd3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dd6:	e8 a5 39 00 00       	call   80106780 <switchkvm>
  seginit();
80102ddb:	e8 e0 38 00 00       	call   801066c0 <seginit>
  lapicinit();
...
80102e13:	e8 f8 3d 00 00       	call   80106c10 <kvmalloc>
...
80102e25:	e8 96 38 00 00       	call   801066c0 <seginit>
  picinit();       // disable pic
...
80102e3a:	e8 a1 2b 00 00       	call   801059e0 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
80102e40:	e8 9b 07 00 00       	call   801035e0 <pinit>
  tvinit();        // trap vectors
80102e45:	e8 c6 27 00 00       	call   80105610 <tvinit>
  binit();         // buffer cache
...
8010350e:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103511:	e8 7a 0e 00 00       	call   80104390 <release>
...
8010352d:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103530:	c7 40 14 05 56 10 80 	movl   $0x80105605,0x14(%eax)
...
8010354a:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
8010354d:	e8 8e 0e 00 00       	call   801043e0 <memset>
...
80103705:	80 
80103706:	e8 a5 31 00 00       	call   801068b0 <inituvm>
  p->sz = PGSIZE;
...
80103809:	e8 e2 31 00 00       	call   801069f0 <allocuvm>
...
80103817:	e8 84 2f 00 00       	call   801067a0 <switchuvm>
  return 0;
...
8010383a:	e8 a1 32 00 00       	call   80106ae0 <deallocuvm>
...
8010387e:	e8 dd 33 00 00       	call   80106c60 <copyuvm>
...
801039b2:	83 eb 80             	sub    $0xffffff80,%ebx
      switchuvm(p);
801039b5:	e8 e6 2d 00 00       	call   801067a0 <switchuvm>
...
801039cb:	e8 4b 0c 00 00       	call   8010461b <swtch>
      switchkvm();
801039d0:	e8 ab 2d 00 00       	call   80106780 <switchkvm>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
801039ef:	e8 9c 09 00 00       	call   80104390 <release>
  }
...
80103aa5:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103aa8:	e8 f3 fb ff ff       	call   801036a0 <myproc>
  if(curproc == initproc)
80103aad:	3b 05 b8 a5 10 80    	cmp    0x8010a5b8,%eax
  struct proc *curproc = myproc();
80103ab3:	89 c3                	mov    %eax,%ebx
  if(curproc == initproc)
80103ab5:	0f 84 f4 00 00 00    	je     80103baf <exit+0x10f>
	curproc->exitStatus = status; // current process status becomes exit status
80103abb:	8b 45 08             	mov    0x8(%ebp),%eax
  for(fd = 0; fd < NOFILE; fd++){
80103abe:	31 f6                	xor    %esi,%esi
	curproc->exitStatus = status; // current process status becomes exit status
80103ac0:	89 43 7c             	mov    %eax,0x7c(%ebx)
80103ac3:	90                   	nop
...
80103b9e:	e8 5d fe ff ff       	call   80103a00 <sched>
  panic("zombie exit");
80103ba3:	c7 04 24 fd 73 10 80 	movl   $0x801073fd,(%esp)
80103baa:	e8 b1 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103baf:	c7 04 24 f0 73 10 80 	movl   $0x801073f0,(%esp)
...
80103bcd:	e8 4e 07 00 00       	call   80104320 <acquire>
...
80103bea:	e8 a1 07 00 00       	call   80104390 <release>
}
80103bef:	c9                   	leave  
80103bf0:	c3                   	ret    
...
80103c31:	e8 ea 06 00 00       	call   80104320 <acquire>
    release(lk);
80103c36:	89 34 24             	mov    %esi,(%esp)
80103c39:	e8 52 07 00 00       	call   80104390 <release>
  p->chan = chan;
...
80103c5b:	e8 30 07 00 00       	call   80104390 <release>
    acquire(lk);
...
80103c69:	5d                   	pop    %ebp
    acquire(lk);
80103c6a:	e9 b1 06 00 00       	jmp    80104320 <acquire>
80103c6f:	90                   	nop
  p->chan = chan;
...
80103cc8:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103cca:	e8 51 06 00 00       	call   80104320 <acquire>
    havekids = 0;
...
80103d38:	e8 c3 2d 00 00       	call   80106b00 <freevm>
	if(status != 0) {
80103d3d:	85 ff                	test   %edi,%edi
        p->pid = 0;
80103d3f:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103d46:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103d4d:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80103d51:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103d58:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
	if(status != 0) {
80103d5f:	74 05                	je     80103d66 <wait+0xb6>
		*status = p->exitStatus;
80103d61:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103d64:	89 07                	mov    %eax,(%edi)
        release(&ptable.lock);
80103d66:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d6d:	e8 1e 06 00 00       	call   80104390 <release>
}
...
80103d83:	e8 08 06 00 00       	call   80104390 <release>
}
...
80103da9:	8b 55 08             	mov    0x8(%ebp),%edx
80103dac:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  struct proc *curproc = myproc();
80103daf:	e8 ec f8 ff ff       	call   801036a0 <myproc>
  acquire(&ptable.lock);
80103db4:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80103dbb:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103dbd:	e8 5e 05 00 00       	call   80104320 <acquire>
80103dc2:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103dc5:	8d 76 00             	lea    0x0(%esi),%esi
   havekids = 0;
80103dc8:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103dca:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103dcf:	eb 12                	jmp    80103de3 <waitpid+0x43>
...
80103de1:	74 7d                	je     80103e60 <waitpid+0xc0>
      if(p->parent != curproc)
80103de3:	39 73 14             	cmp    %esi,0x14(%ebx)
80103de6:	75 f0                	jne    80103dd8 <waitpid+0x38>
...
80103de8:	8b 7b 10             	mov    0x10(%ebx),%edi
      havekids = 1;
80103deb:	b8 01 00 00 00       	mov    $0x1,%eax
      if(pid == p->pid && p->state == ZOMBIE){ //The system call must wait for a process (not necessary a child process) with a pid that equals to one provided by the pid argument.
80103df0:	39 d7                	cmp    %edx,%edi
80103df2:	75 e4                	jne    80103dd8 <waitpid+0x38>
80103df4:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103df8:	75 de                	jne    80103dd8 <waitpid+0x38>
        kfree(p->kstack);
80103dfa:	8b 43 08             	mov    0x8(%ebx),%eax
80103dfd:	89 04 24             	mov    %eax,(%esp)
80103e00:	e8 eb e4 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
80103e05:	8b 43 04             	mov    0x4(%ebx),%eax
        p->kstack = 0;
80103e08:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103e0f:	89 04 24             	mov    %eax,(%esp)
80103e12:	e8 e9 2c 00 00       	call   80106b00 <freevm>
        if(status != 0) { 
80103e17:	8b 55 0c             	mov    0xc(%ebp),%edx
        p->pid = 0; 
80103e1a:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103e21:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103e28:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        if(status != 0) { 
80103e2c:	85 d2                	test   %edx,%edx
        p->killed = 0;
80103e2e:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103e35:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        if(status != 0) { 
80103e3c:	74 08                	je     80103e46 <waitpid+0xa6>
                *status = p->exitStatus;
80103e3e:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103e41:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80103e44:	89 01                	mov    %eax,(%ecx)
        release(&ptable.lock);
80103e46:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103e4d:	e8 3e 05 00 00       	call   80104390 <release>
} //waitpid END
80103e52:	83 c4 1c             	add    $0x1c,%esp
80103e55:	89 f8                	mov    %edi,%eax
80103e57:	5b                   	pop    %ebx
80103e58:	5e                   	pop    %esi
80103e59:	5f                   	pop    %edi
80103e5a:	5d                   	pop    %ebp
...
80103e62:	74 22                	je     80103e86 <waitpid+0xe6>
80103e64:	8b 46 24             	mov    0x24(%esi),%eax
80103e67:	85 c0                	test   %eax,%eax
80103e69:	75 1b                	jne    80103e86 <waitpid+0xe6>
    sleep(curproc, &ptable.lock); // Doc: wait-sleep
80103e6b:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
80103e72:	80 
80103e73:	89 34 24             	mov    %esi,(%esp)
80103e76:	89 55 e4             	mov    %edx,-0x1c(%ebp)
80103e79:	e8 82 fd ff ff       	call   80103c00 <sleep>
   }
80103e7e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103e81:	e9 42 ff ff ff       	jmp    80103dc8 <waitpid+0x28>
      release(&ptable.lock);
80103e86:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
      return -1;
80103e8d:	bf ff ff ff ff       	mov    $0xffffffff,%edi
      release(&ptable.lock);
80103e92:	e8 f9 04 00 00       	call   80104390 <release>
} //waitpid END
80103e97:	83 c4 1c             	add    $0x1c,%esp
80103e9a:	89 f8                	mov    %edi,%eax
80103e9c:	5b                   	pop    %ebx
80103e9d:	5e                   	pop    %esi
80103e9e:	5f                   	pop    %edi
80103e9f:	5d                   	pop    %ebp
80103ea0:	c3                   	ret    
80103ea1:	eb 0d                	jmp    80103eb0 <wakeup>
80103ea3:	90                   	nop
80103ea4:	90                   	nop
80103ea5:	90                   	nop
80103ea6:	90                   	nop
...
80103ec1:	e8 5a 04 00 00       	call   80104320 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
80103f03:	5d                   	pop    %ebp
  release(&ptable.lock);
80103f04:	e9 87 04 00 00       	jmp    80104390 <release>
...
80103f21:	e8 fa 03 00 00       	call   80104320 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80103f53:	e8 38 04 00 00       	call   80104390 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103f77:	e8 14 04 00 00       	call   80104390 <release>
}
...
80103fd4:	8b 14 85 a8 74 10 80 	mov    -0x7fef8b58(,%eax,4),%edx
      state = "???";
...
8010401c:	e8 af 01 00 00       	call   801041d0 <getcallerpcs>
...
80104066:	c7 04 24 80 74 10 80 	movl   $0x80107480,(%esp)
8010406d:	e8 de c5 ff ff       	call   80100650 <cprintf>
} //new for lab1
80104072:	c9                   	leave  
80104073:	c3                   	ret    
...
8010408a:	c7 44 24 04 c0 74 10 	movl   $0x801074c0,0x4(%esp)
80104091:	80 
...
801040e7:	e8 14 fb ff ff       	call   80103c00 <sleep>
  while (lk->locked) {
...
80104146:	e8 65 fd ff ff       	call   80103eb0 <wakeup>
  release(&lk->lk);
...
801042b9:	c3                   	ret    
    panic("popcli");
801042ba:	c7 04 24 e2 74 10 80 	movl   $0x801074e2,(%esp)
801042c1:	e8 9a c0 ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
801042c6:	c7 04 24 cb 74 10 80 	movl   $0x801074cb,(%esp)
...
80104374:	c3                   	ret    
    panic("acquire");
80104375:	c7 04 24 e9 74 10 80 	movl   $0x801074e9,(%esp)
...
801043c2:	e9 a9 fe ff ff       	jmp    80104270 <popcli>
    panic("release");
801043c7:	c7 04 24 f1 74 10 80 	movl   $0x801074f1,(%esp)
...
80104677:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010467a:	e8 21 f0 ff ff       	call   801036a0 <myproc>
...
801047a0 <syscall>:
[SYS_waitpid] sys_waitpid, //new for lab1
};
...
801047a5:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
801047a8:	e8 f3 ee ff ff       	call   801036a0 <myproc>
...
801047b8:	83 fa 16             	cmp    $0x16,%edx
801047bb:	77 1b                	ja     801047d8 <syscall+0x38>
801047bd:	8b 14 85 20 75 10 80 	mov    -0x7fef8ae0(,%eax,4),%edx
...
801047e6:	c7 04 24 f9 74 10 80 	movl   $0x801074f9,(%esp)
...
80104816:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
80104819:	e8 82 ee ff ff       	call   801036a0 <myproc>
...
80104856:	83 ec 3c             	sub    $0x3c,%esp
80104859:	89 4d d0             	mov    %ecx,-0x30(%ebp)
...
{
80104869:	89 55 d4             	mov    %edx,-0x2c(%ebp)
8010486c:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010486f:	e8 ac d6 ff ff       	call   80101f20 <nameiparent>
...
80104881:	e8 2a ce ff ff       	call   801016b0 <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80104886:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010488d:	00 
8010488e:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80104892:	89 3c 24             	mov    %edi,(%esp)
80104895:	e8 26 d3 ff ff       	call   80101bc0 <dirlookup>
8010489a:	85 c0                	test   %eax,%eax
8010489c:	89 c6                	mov    %eax,%esi
8010489e:	74 40                	je     801048e0 <create+0x90>
    iunlockput(dp);
801048a0:	89 3c 24             	mov    %edi,(%esp)
801048a3:	e8 68 d0 ff ff       	call   80101910 <iunlockput>
    ilock(ip);
801048a8:	89 34 24             	mov    %esi,(%esp)
801048ab:	e8 00 ce ff ff       	call   801016b0 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
801048b0:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
801048b5:	75 11                	jne    801048c8 <create+0x78>
801048b7:	66 83 7e 50 02       	cmpw   $0x2,0x50(%esi)
801048bc:	89 f0                	mov    %esi,%eax
801048be:	75 08                	jne    801048c8 <create+0x78>
...
801048cb:	e8 40 d0 ff ff       	call   80101910 <iunlockput>
}
801048d0:	83 c4 3c             	add    $0x3c,%esp
    return 0;
...
801048ff:	e8 ac cd ff ff       	call   801016b0 <ilock>
  ip->major = major;
80104904:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
80104908:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
8010490c:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
...
80104920:	e8 cb cc ff ff       	call   801015f0 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80104925:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
...
80104946:	e8 c5 cf ff ff       	call   80101910 <iunlockput>
}
8010494b:	83 c4 3c             	add    $0x3c,%esp
  return ip;
...
80104b73:	78 23                	js     80104b98 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80104b75:	e8 26 eb ff ff       	call   801036a0 <myproc>
...
80104c29:	0f 88 cb 00 00 00    	js     80104cfa <sys_link+0x10a>
  begin_op();
80104c2f:	e8 dc de ff ff       	call   80102b10 <begin_op>
  if((ip = namei(old)) == 0){
80104c34:	8b 45 d4             	mov    -0x2c(%ebp),%eax
80104c37:	89 04 24             	mov    %eax,(%esp)
80104c3a:	e8 c1 d2 ff ff       	call   80101f00 <namei>
...
80104c67:	e8 84 c9 ff ff       	call   801015f0 <iupdate>
  iunlock(ip);
80104c6c:	89 1c 24             	mov    %ebx,(%esp)
80104c6f:	e8 1c cb ff ff       	call   80101790 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104c74:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104c77:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104c7b:	89 04 24             	mov    %eax,(%esp)
80104c7e:	e8 9d d2 ff ff       	call   80101f20 <nameiparent>
...
80104ca5:	e8 76 d1 ff ff       	call   80101e20 <dirlink>
80104caa:	85 c0                	test   %eax,%eax
80104cac:	78 22                	js     80104cd0 <sys_link+0xe0>
  iunlockput(dp);
80104cae:	89 34 24             	mov    %esi,(%esp)
80104cb1:	e8 5a cc ff ff       	call   80101910 <iunlockput>
  iput(ip);
80104cb6:	89 1c 24             	mov    %ebx,(%esp)
80104cb9:	e8 12 cb ff ff       	call   801017d0 <iput>
  end_op();
80104cbe:	e8 bd de ff ff       	call   80102b80 <end_op>
}
...
80104cd3:	e8 38 cc ff ff       	call   80101910 <iunlockput>
  ilock(ip);
80104cd8:	89 1c 24             	mov    %ebx,(%esp)
80104cdb:	e8 d0 c9 ff ff       	call   801016b0 <ilock>
  ip->nlink--;
...
80104d2e:	0f 88 76 01 00 00    	js     80104eaa <sys_unlink+0x19a>
  begin_op();
80104d34:	e8 d7 dd ff ff       	call   80102b10 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104d46:	e8 d5 d1 ff ff       	call   80101f20 <nameiparent>
...
80104d61:	c7 44 24 04 9c 75 10 	movl   $0x8010759c,0x4(%esp)
80104d68:	80 
80104d69:	89 1c 24             	mov    %ebx,(%esp)
80104d6c:	e8 1f ce ff ff       	call   80101b90 <namecmp>
80104d71:	85 c0                	test   %eax,%eax
80104d73:	0f 84 21 01 00 00    	je     80104e9a <sys_unlink+0x18a>
80104d79:	c7 44 24 04 9b 75 10 	movl   $0x8010759b,0x4(%esp)
80104d80:	80 
80104d81:	89 1c 24             	mov    %ebx,(%esp)
80104d84:	e8 07 ce ff ff       	call   80101b90 <namecmp>
...
80104d9f:	e8 1c ce ff ff       	call   80101bc0 <dirlookup>
...
80104db1:	e8 fa c8 ff ff       	call   801016b0 <ilock>
  if(ip->nlink < 1)
...
80104dfc:	e8 5f cc ff ff       	call   80101a60 <writei>
...
80104e1b:	e8 f0 ca ff ff       	call   80101910 <iunlockput>
  ip->nlink--;
80104e20:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104e25:	89 1c 24             	mov    %ebx,(%esp)
80104e28:	e8 c3 c7 ff ff       	call   801015f0 <iupdate>
  iunlockput(ip);
80104e2d:	89 1c 24             	mov    %ebx,(%esp)
80104e30:	e8 db ca ff ff       	call   80101910 <iunlockput>
  end_op();
80104e35:	e8 46 dd ff ff       	call   80102b80 <end_op>
}
...
80104e81:	e8 da ca ff ff       	call   80101960 <readi>
...
80104e95:	e8 76 ca ff ff       	call   80101910 <iunlockput>
  iunlockput(dp);
...
80104ec3:	e8 28 c7 ff ff       	call   801015f0 <iupdate>
80104ec8:	e9 48 ff ff ff       	jmp    80104e15 <sys_unlink+0x105>
      panic("isdirempty: readi");
80104ecd:	c7 04 24 c0 75 10 80 	movl   $0x801075c0,(%esp)
80104ed4:	e8 87 b4 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104ed9:	c7 04 24 d2 75 10 80 	movl   $0x801075d2,(%esp)
80104ee0:	e8 7b b4 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104ee5:	c7 04 24 ae 75 10 80 	movl   $0x801075ae,(%esp)
...
80104f39:	0f 88 b6 00 00 00    	js     80104ff5 <sys_open+0xf5>
  ...
  begin_op();
80104f3f:	e8 cc db ff ff       	call   80102b10 <begin_op>
...
80104f54:	e8 a7 cf ff ff       	call   80101f00 <namei>
...
80104f66:	e8 45 c7 ff ff       	call   801016b0 <ilock>
...
80104f97:	e8 f4 c7 ff ff       	call   80101790 <iunlock>
  end_op();
80104f9c:	e8 df db ff ff       	call   80102b80 <end_op>
...
801050a3:	83 ec 28             	sub    $0x28,%esp
  ...
  begin_op();
801050a6:	e8 65 da ff ff       	call   80102b10 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
80105135:	83 ec 20             	sub    $0x20,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105138:	e8 63 e5 ff ff       	call   801036a0 <myproc>
8010513d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010513f:	e8 cc d9 ff ff       	call   80102b10 <begin_op>
...
80105161:	e8 9a cd ff ff       	call   80101f00 <namei>
...
8010516f:	e8 3c c5 ff ff       	call   801016b0 <ilock>
  if(ip->type != T_DIR){
...
801051a0:	e8 6b c7 ff ff       	call   80101910 <iunlockput>
    end_op();
801051a5:	e8 d6 d9 ff ff       	call   80102b80 <end_op>
}
...
801052e3:	e8 88 de ff ff       	call   80103170 <pipealloc>
...
80105353:	5d                   	pop    %ebp
  return fork();
80105354:	e9 f7 e4 ff ff       	jmp    80103850 <fork>
...
8010537b:	78 13                	js     80105390 <sys_exit+0x30>
		return -1;
	}
	exit(status);
8010537d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105380:	89 04 24             	mov    %eax,(%esp)
80105383:	e8 18 e7 ff ff       	call   80103aa0 <exit>
...
801053bc:	e8 3f f3 ff ff       	call   80104700 <argptr>
...
801053cb:	e8 e0 e8 ff ff       	call   80103cb0 <wait>
}
801053d0:	c9                   	leave  
801053d1:	c3                   	ret    
...
801053f4:	e8 d7 f2 ff ff       	call   801046d0 <argint>
801053f9:	85 c0                	test   %eax,%eax
801053fb:	78 53                	js     80105450 <sys_waitpid+0x70>
		return -1;
	}

        if(argptr(1, (void*)&status, sizeof(status)) < 0) {
801053fd:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105400:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
80105407:	00 
80105408:	89 44 24 04          	mov    %eax,0x4(%esp)
8010540c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105413:	e8 e8 f2 ff ff       	call   80104700 <argptr>
80105418:	85 c0                	test   %eax,%eax
8010541a:	78 34                	js     80105450 <sys_waitpid+0x70>
                return -1;
        }
...
80105423:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010542a:	e8 a1 f2 ff ff       	call   801046d0 <argint>
8010542f:	85 c0                	test   %eax,%eax
80105431:	78 1d                	js     80105450 <sys_waitpid+0x70>
		return -1;
	}
...
80105441:	8b 45 ec             	mov    -0x14(%ebp),%eax
80105444:	89 04 24             	mov    %eax,(%esp)
80105447:	e8 54 e9 ff ff       	call   80103da0 <waitpid>
}
8010544c:	c9                   	leave  
8010544d:	c3                   	ret    
...
80105474:	e8 57 f2 ff ff       	call   801046d0 <argint>
...
80105483:	e8 88 ea ff ff       	call   80103f10 <kill>
}
80105488:	c9                   	leave  
80105489:	c3                   	ret    
...
801054a3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801054a6:	e8 f5 e1 ff ff       	call   801036a0 <myproc>
...
801054c5:	e8 06 f2 ff ff       	call   801046d0 <argint>
801054ca:	85 c0                	test   %eax,%eax
801054cc:	78 22                	js     801054f0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801054ce:	e8 cd e1 ff ff       	call   801036a0 <myproc>
  if(growproc(n) < 0)
...
801054db:	e8 00 e3 ff ff       	call   801037e0 <growproc>
...
80105515:	e8 b6 f1 ff ff       	call   801046d0 <argint>
8010551a:	85 c0                	test   %eax,%eax
8010551c:	78 7e                	js     8010559c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010551e:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105525:	e8 f6 ed ff ff       	call   80104320 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010552a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010552d:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
...
80105540:	c7 44 24 04 60 4d 11 	movl   $0x80114d60,0x4(%esp)
80105547:	80 
80105548:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
8010554f:	e8 ac e6 ff ff       	call   80103c00 <sleep>
  while(ticks - ticks0 < n){
80105554:	a1 a0 55 11 80       	mov    0x801155a0,%eax
...
8010556a:	74 d4                	je     80105540 <sys_sleep+0x40>
      release(&tickslock);
8010556c:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105573:	e8 18 ee ff ff       	call   80104390 <release>
      return -1;
...
80105584:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
80105588:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
8010558f:	e8 fc ed ff ff       	call   80104390 <release>
}
...
801055b3:	83 ec 08             	sub    $0x8,%esp
	hello();
801055b6:	e8 a5 ea ff ff       	call   80104060 <hello>
	return 0;
} //new for lab1
...
801055c4:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
801055c7:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801055ce:	e8 4d ed ff ff       	call   80104320 <acquire>
  xticks = ticks;
801055d3:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
801055d9:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801055e0:	e8 ab ed ff ff       	call   80104390 <release>
  return xticks;
}
...
80105624:	66 89 0c c5 a2 4d 11 	mov    %cx,-0x7feeb25e(,%eax,8)
8010562b:	80 
8010562c:	c6 04 c5 a4 4d 11 80 	movb   $0x0,-0x7feeb25c(,%eax,8)
80105633:	00 
80105634:	c6 04 c5 a5 4d 11 80 	movb   $0x8e,-0x7feeb25b(,%eax,8)
8010563b:	8e 
8010563c:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
80105643:	80 
80105644:	c1 ea 10             	shr    $0x10,%edx
80105647:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
8010564e:	80 
  for(i = 0; i < 256; i++)
...
80105669:	c7 44 24 04 e1 75 10 	movl   $0x801075e1,0x4(%esp)
80105670:	80 
80105671:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105678:	66 89 15 a2 4f 11 80 	mov    %dx,0x80114fa2
8010567f:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
80105685:	c1 e8 10             	shr    $0x10,%eax
80105688:	c6 05 a4 4f 11 80 00 	movb   $0x0,0x80114fa4
8010568f:	c6 05 a5 4f 11 80 ef 	movb   $0xef,0x80114fa5
80105696:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010569c:	e8 0f eb ff ff       	call   801041b0 <initlock>
}
801056a1:	c9                   	leave  
801056a2:	c3                   	ret    
...
801056bb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801056bf:	b8 a0 4d 11 80       	mov    $0x80114da0,%eax
...
80105700:	ff 24 85 88 76 10 80 	jmp    *-0x7fef8978(,%eax,4)
80105707:	90                   	nop
    lapiceoi();
    break;
...
80105708:	e8 93 df ff ff       	call   801036a0 <myproc>
...
8010572c:	e8 4f df ff ff       	call   80103680 <cpuid>
...
80105773:	c7 04 24 44 76 10 80 	movl   $0x80107644,(%esp)
8010577a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010577e:	e8 cd ae ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105783:	e8 18 df ff ff       	call   801036a0 <myproc>
...
80105799:	e8 02 df ff ff       	call   801036a0 <myproc>
...
801057a5:	e8 f6 de ff ff       	call   801036a0 <myproc>
...
801057b9:	74 55                	je     80105810 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801057bb:	e8 e0 de ff ff       	call   801036a0 <myproc>
801057c0:	85 c0                	test   %eax,%eax
801057c2:	74 1d                	je     801057e1 <trap+0x101>
801057c4:	e8 d7 de ff ff       	call   801036a0 <myproc>
...
80105804:	e8 97 e2 ff ff       	call   80103aa0 <exit>
...
80105867:	e8 14 de ff ff       	call   80103680 <cpuid>
8010586c:	c7 04 24 ec 75 10 80 	movl   $0x801075ec,(%esp)
...
8010587f:	e8 cc ad ff ff       	call   80100650 <cprintf>
    lapiceoi();
80105884:	e8 f7 ce ff ff       	call   80102780 <lapiceoi>
    break;
80105889:	e9 02 ff ff ff       	jmp    80105790 <trap+0xb0>
8010588e:	66 90                	xchg   %ax,%ax
    ideintr();
80105890:	e8 eb c7 ff ff       	call   80102080 <ideintr>
...
801058aa:	75 34                	jne    801058e0 <trap+0x200>
    myproc()->tf = tf;
801058ac:	e8 ef dd ff ff       	call   801036a0 <myproc>
801058b1:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
801058b4:	e8 e7 ee ff ff       	call   801047a0 <syscall>
    if(myproc()->killed)
801058b9:	e8 e2 dd ff ff       	call   801036a0 <myproc>
...
801058d6:	5d                   	pop    %ebp
      exit(0);
801058d7:	e9 c4 e1 ff ff       	jmp    80103aa0 <exit>
801058dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      exit(0);
801058e0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801058e7:	e8 b4 e1 ff ff       	call   80103aa0 <exit>
801058ec:	eb be                	jmp    801058ac <trap+0x1cc>
801058ee:	66 90                	xchg   %ax,%ax
      acquire(&tickslock);
801058f0:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
801058f7:	e8 24 ea ff ff       	call   80104320 <acquire>
      wakeup(&ticks);
801058fc:	c7 04 24 a0 55 11 80 	movl   $0x801155a0,(%esp)
      ticks++;
80105903:	83 05 a0 55 11 80 01 	addl   $0x1,0x801155a0
      wakeup(&ticks);
8010590a:	e8 a1 e5 ff ff       	call   80103eb0 <wakeup>
      release(&tickslock);
8010590f:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
80105916:	e8 75 ea ff ff       	call   80104390 <release>
8010591b:	e9 0d ff ff ff       	jmp    8010582d <trap+0x14d>
80105920:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105923:	8b 73 38             	mov    0x38(%ebx),%esi
80105926:	e8 55 dd ff ff       	call   80103680 <cpuid>
...
8010593a:	c7 04 24 10 76 10 80 	movl   $0x80107610,(%esp)
80105941:	89 44 24 04          	mov    %eax,0x4(%esp)
80105945:	e8 06 ad ff ff       	call   80100650 <cprintf>
      panic("trap");
8010594a:	c7 04 24 e6 75 10 80 	movl   $0x801075e6,(%esp)
...
801059b7:	e8 e4 cd ff ff       	call   801027a0 <microdelay>
...
80105a47:	00 
  for(p="xv6...\n"; *p; p++)
80105a48:	bb 08 77 10 80       	mov    $0x80107708,%ebx
  ioapicenable(IRQ_COM1, 0);
80105a4d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105a54:	e8 57 c8 ff ff       	call   801022b0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80106554:	e8 47 bf ff ff       	call   801024a0 <kalloc>
...
80106572:	e8 69 de ff ff       	call   801043e0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106611:	c3                   	ret    
      panic("remap");
80106612:	c7 04 24 10 77 10 80 	movl   $0x80107710,(%esp)
...
80106663:	e8 88 bc ff ff       	call   801022f0 <kfree>
      *pte = 0;
...
801066c3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801066c6:	e8 b5 cf ff ff       	call   80103680 <cpuid>
...
80106780:	a1 a4 55 11 80       	mov    0x801155a4,%eax
{
...
801067c4:	0f 84 c3 00 00 00    	je     8010688d <switchuvm+0xed>
  pushcli();
801067ca:	e8 61 da ff ff       	call   80104230 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801067cf:	e8 2c ce ff ff       	call   80103600 <mycpu>
801067d4:	89 c3                	mov    %eax,%ebx
801067d6:	e8 25 ce ff ff       	call   80103600 <mycpu>
801067db:	89 c7                	mov    %eax,%edi
801067dd:	e8 1e ce ff ff       	call   80103600 <mycpu>
...
8010687b:	5d                   	pop    %ebp
  popcli();
8010687c:	e9 ef d9 ff ff       	jmp    80104270 <popcli>
    panic("switchuvm: no process");
80106881:	c7 04 24 16 77 10 80 	movl   $0x80107716,(%esp)
80106888:	e8 d3 9a ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
8010688d:	c7 04 24 41 77 10 80 	movl   $0x80107741,(%esp)
80106894:	e8 c7 9a ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106899:	c7 04 24 2c 77 10 80 	movl   $0x8010772c,(%esp)
...
801068cb:	77 54                	ja     80106921 <inituvm+0x71>
  mem = kalloc();
801068cd:	e8 ce bb ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
...
801068e7:	e8 f4 da ff ff       	call   801043e0 <memset>
...
8010691b:	5d                   	pop    %ebp
  memmove(mem, init, sz);
8010691c:	e9 5f db ff ff       	jmp    80104480 <memmove>
    panic("inituvm: more than a page");
80106921:	c7 04 24 55 77 10 80 	movl   $0x80107755,(%esp)
...
801069ad:	e8 ae af ff ff       	call   80101960 <readi>
...
801069d2:	c7 04 24 6f 77 10 80 	movl   $0x8010776f,(%esp)
801069d9:	e8 82 99 ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
801069de:	c7 04 24 10 78 10 80 	movl   $0x80107810,(%esp)
...
80106a33:	e8 a8 d9 ff ff       	call   801043e0 <memset>
...
80106a64:	76 2a                	jbe    80106a90 <allocuvm+0xa0>
    mem = kalloc();
80106a66:	e8 35 ba ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
...
80106a71:	c7 04 24 8d 77 10 80 	movl   $0x8010778d,(%esp)
...
80106aa0:	c7 04 24 a5 77 10 80 	movl   $0x801077a5,(%esp)
...
80106ac1:	e8 2a b8 ff ff       	call   801022f0 <kfree>
      return 0;
...
80106b4d:	e8 9e b7 ff ff       	call   801022f0 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
...
80106b62:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106b63:	e9 88 b7 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106b68:	c7 04 24 c1 77 10 80 	movl   $0x801077c1,(%esp)
...
80106b88:	e8 13 b9 ff ff       	call   801024a0 <kalloc>
...
80106bab:	e8 30 d8 ff ff       	call   801043e0 <memset>
...
80106c1b:	a3 a4 55 11 80       	mov    %eax,0x801155a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106c4b:	c3                   	ret    
    panic("clearpteu");
80106c4c:	c7 04 24 d2 77 10 80 	movl   $0x801077d2,(%esp)
...
80106c73:	0f 84 b9 00 00 00    	je     80106d32 <copyuvm+0xd2>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106c79:	8b 45 0c             	mov    0xc(%ebp),%eax
80106c7c:	85 c0                	test   %eax,%eax
80106c7e:	0f 84 94 00 00 00    	je     80106d18 <copyuvm+0xb8>
80106c84:	31 ff                	xor    %edi,%edi
...
80106c88:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106c8e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c95:	00 
80106c96:	89 74 24 04          	mov    %esi,0x4(%esp)
80106c9a:	89 04 24             	mov    %eax,(%esp)
80106c9d:	e8 de d7 ff ff       	call   80104480 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106ca2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106ca5:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106caa:	89 fa                	mov    %edi,%edx
80106cac:	89 44 24 04          	mov    %eax,0x4(%esp)
80106cb0:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
...
80106cc3:	78 63                	js     80106d28 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106cc5:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106ccb:	39 7d 0c             	cmp    %edi,0xc(%ebp)
80106cce:	76 48                	jbe    80106d18 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106cd0:	8b 45 08             	mov    0x8(%ebp),%eax
80106cd3:	31 c9                	xor    %ecx,%ecx
80106cd5:	89 fa                	mov    %edi,%edx
80106cd7:	e8 34 f8 ff ff       	call   80106510 <walkpgdir>
80106cdc:	85 c0                	test   %eax,%eax
80106cde:	74 62                	je     80106d42 <copyuvm+0xe2>
    if(!(*pte & PTE_P))
80106ce0:	8b 00                	mov    (%eax),%eax
80106ce2:	a8 01                	test   $0x1,%al
80106ce4:	74 50                	je     80106d36 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80106ce6:	89 c6                	mov    %eax,%esi
    flags = PTE_FLAGS(*pte);
80106ce8:	25 ff 0f 00 00       	and    $0xfff,%eax
80106ced:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106cf0:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if((mem = kalloc()) == 0)
80106cf6:	e8 a5 b7 ff ff       	call   801024a0 <kalloc>
80106cfb:	85 c0                	test   %eax,%eax
80106cfd:	89 c3                	mov    %eax,%ebx
80106cff:	75 87                	jne    80106c88 <copyuvm+0x28>
    }
  }
  return d;
...
bad:
  freevm(d);
80106d01:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106d04:	89 04 24             	mov    %eax,(%esp)
80106d07:	e8 f4 fd ff ff       	call   80106b00 <freevm>
  return 0;
80106d0c:	31 c0                	xor    %eax,%eax
}
80106d0e:	83 c4 2c             	add    $0x2c,%esp
80106d11:	5b                   	pop    %ebx
80106d12:	5e                   	pop    %esi
80106d13:	5f                   	pop    %edi
80106d14:	5d                   	pop    %ebp
...
80106d24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      kfree(mem);
80106d28:	89 1c 24             	mov    %ebx,(%esp)
80106d2b:	e8 c0 b5 ff ff       	call   801022f0 <kfree>
      goto bad;
80106d30:	eb cf                	jmp    80106d01 <copyuvm+0xa1>
    return 0;
80106d32:	31 c0                	xor    %eax,%eax
80106d34:	eb d8                	jmp    80106d0e <copyuvm+0xae>
      panic("copyuvm: page not present");
80106d36:	c7 04 24 f6 77 10 80 	movl   $0x801077f6,(%esp)
80106d3d:	e8 1e 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106d42:	c7 04 24 dc 77 10 80 	movl   $0x801077dc,(%esp)
80106d49:	e8 12 96 ff ff       	call   80100360 <panic>
...
80106dcc:	e8 af d6 ff ff       	call   80104480 <memmove>
    len -= n;
    buf += n;
